	...
	<menu>
		<div class="container clearfix">
			<ul class="clearfix f_left">
				<li><a href="/zy/front/backtoindex.action">首页</a></li>
				<li class="menu_active"><a href="/zy/front/user/index.action">个人中心</a></li>
			</ul>
			<div id="user_bar">
				...
				<a href="/zy/front/user/logout.action" id="lay_out">退出</a>
			</div>
		</div>
	</menu>
</header>
