...
<div class="mask hidden" id="loginDiv">
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="loginForm" action="/zy/front/user/login.action" method="post">
				<h3>快速登录</h3>
				...
				<div id="forget">
					<a href="/zy/front/forgetpwd.action">忘记密码？</a>
				</div>
...
<div class="mask hidden" id="regDiv">
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="regForm" action="/zy/front/user/rigist.action" method="post">
				<h3>新用户注册</h3>
