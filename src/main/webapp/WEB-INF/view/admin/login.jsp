...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/messages_zh.min.js"></script>	
	...
	<div class="login">
		...
		<input style="width:20%;" class="img-rounded" type="text"  size="3" name="loginName" placeholder="用户名"  ><br>
		<input type="password" class="img-rounded" style="width:20%;" name="loginPwd" placeholder="密码" size="3"/><br>
